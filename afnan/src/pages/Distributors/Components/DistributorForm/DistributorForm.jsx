        ...
        <>
            <header className="PageHeader ok">
                <div className="SectionHeader SectionHeader--center">
                    <h1 className="SectionHeader__Heading Heading u-h1">DISTRIBUTORS GENERAL PAGE</h1>
                </div>
            </header>
            <div className='PageContent PageContent--narrow Rte'>
                <p>AFNAN PERFUMES distribute to all around the world bringing local perfumes to international market.</p>
                <p>
                    <Link target="_blank" className='custom-link' to="/" rel="noopener noreferrer"><span>Download AFNAN PERFUME portfolio</span></Link>
                </p>
